...
public interface TestConstants {
    String LIST_USERS_URL = "https://reqres.in/api/users?page=2";
    ...
    String SINGLE_USER_URL = "https://reqres.in/api/users/2";
    ...
    String LIST_COLORS_URL = "https://reqres.in/api/unknown";
}
